...
[<img src="https://img.shields.io/badge/Download-v0.1.0-28A745?style=for-the-badge&logo=apple&logoColor=white" alt="Download">](https://github.com/kanguk01/FloatRec/releases/latest)
...
> **요구 사항** — macOS 14.0 (Sonoma) 이상 · 라이브 녹화는 macOS 15+ 필요
...
녹화가 끝나면 우하단에 플로팅 셸프가 나타납니다. 후처리 진행 상태를 실시간으로 보여주며, 완료되면 바로 저장하거나 공유할 수 있습니다.
